    ...
    /* window.onload = function() {
        ...
        function centerText(ctx, text, y) {
          ...
          function draw(ctx, elapsed) {
            ...
            ctx.fillStyle = color;
            ctx.font = '24px monospace';
            centerText(ctx, 'chose a character to begin', y + 30);
          }

          centerText(ctx, title, 0);
          draw(ctx);
          //ctx.drawImage(Resources.get('images/char-boy.png'), 200, 400);
          ...
          var chooseCharacter = function() {
            ...
            document.addEventListener('keyup', function(e) {
                ...
                characterScroll(allowedKeys[e.keyCode], activeCharacter);
            })
